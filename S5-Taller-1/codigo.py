...
while True:
    ...
    print()
    print(" "*20,"Menu"," "*20)
    print("1.-Ingreso analista")
    print("2.-ingreso Administrador")
    print("3.-Salir")
    opc= int(input("Ingrese una opcion [1...3]: "))
    if opc ==1:
        os.system("cls")
        print(" "*20,"Opcion del sistema"," "*20)
        print("1.- Consultar estado del buro crediticio ")
        print("2.- Volver al menu principal")
        print("3.- Presione cualquier tecla para salir")
        opc2=input("Ingrese una opcion [1...3]: ")
        if opc2 == '1':
            os.system("cls")
            notas = OpcSistema("0954561551001","Central de riesgo","85","Byron Llanos","Personal natural","Credi Hogar","095456151001")
        ...
        if opc4 == '1':
            os.system("cls")
            notas2= OpcSistema("0954561551001","Byron Llanos","85","Octavio","Administrador","Credi Hogar","0954561551001")
